...
var file_cart_proto_rawDesc = []byte{
	...
	0x79, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x32, 0xa9, 0x01, 0x0a, 0x0b, 0x55, 0x73,
	0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x07, 0x41, 0x64, 0x64,
...
var file_cart_proto_depIdxs = []int32{
	...
	1, // 2: cart.UserService.AddItem:input_type -> cart.AddItemReq
	3, // 3: cart.UserService.GetCart:input_type -> cart.GetCartReq
	5, // 4: cart.UserService.EmptyCart:input_type -> cart.EmptyCartReq
	2, // 5: cart.UserService.AddItem:output_type -> cart.AddItemResp
	4, // 6: cart.UserService.GetCart:output_type -> cart.GetCartResp
	6, // 7: cart.UserService.EmptyCart:output_type -> cart.EmptyCartResp
